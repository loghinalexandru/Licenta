...
După cum se observă funcția de $log-likelihood$ este monoton crescătoare și modelul de la un anumit numar de interații converge.
...
Meniul principal este contruit în aceeași scenă ca și jocul principal. Pentru butoanele $3D$, ce au fost mai apoi alungite, s-a folosit $Blender$ împreună cu fontul $Borg$ ce este folosit mai peste tot în cadrul jocului pentru a păstra consistența.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{Full.png} \par
