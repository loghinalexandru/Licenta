...
\item \textbf{Componente din Unity} : module $built-in$ ce au ajutat la construirea aplicații de la coliziuni până la animații.
\end{itemize}
...
\textbf{Prefabs} este directorul cu toate prefabricatele din joc, incluzând modelele pentru platforme, obiecte, jucător cât și inamic.
